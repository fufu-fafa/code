...
def bfs_path(snake_head, food_position, snake_list, width, height):
...
def ai_snake_direction(snake_head, food_position, snake_list, width, height, fallback_direction):
    path = bfs_path(snake_head, food_position, snake_list, width, height)
...
def gameLoop():
    ...
    while not game_over:
        ...
        # AI controls
        x1_change, y1_change = ai_snake_direction([x1, y1], [foodx, foody], snake_List, width, height, (x1_change, y1_change))
